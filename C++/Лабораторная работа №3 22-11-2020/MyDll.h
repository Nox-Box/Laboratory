...
namespace Dll {
	...
	private:
		...
		int daymount[12] = { 31,29,31,30,31,30,31,31,30,31,30,31 };//Ìåñÿöà âèñîêîñíîãî ãîäà

		//Ïðîâåðêà íà âèñîêîñíûé ãîä
		bool leapyear() {
			if ((year % 400 == 0) || ((year % 4 == 0) && (year % 100 != 0))) return true;
			else return false;
		}

		//Ïðîâåðêà íà ïðåâûøåíèå äîïóñòèìûõ äàííûõ
		bool Excess() {
