...
int main()
{
    ...
    if (choice == 1) {
        ...
        try
        {
            if (0 >= a)
            {
                Exceptions C(a, "Такого радиуса быть не может");
                throw  C;
            }
        ...
        try
        {
            if (0 >= a)
            {
                Exceptions C(a, "Такой длины быть не может");
                throw  C;
            }
            if (0 >= b)
            {
                Exceptions C(b, "Такой ширины быть не может");
                throw  C;
            }
        }
        catch (Exceptions C)
        ...
        try
        {
            if (0 >= a)
            {
                Exceptions C(a, "Такой длины основания быть не может");
                throw  C;
            }
            if (0 >= b)
            {
                Exceptions C(b, "Такой боковой стороны быть не может");
                throw  C;
            }
        }
        catch (Exceptions C)
